...
import TEMPLATE from "../partials/js/order-again.js";
...
function paintSettings() {
  ...
  document.getElementById("text-input-id-title-font-size").value =
    titleFontSize;
  document.getElementById("text-input-id-title-font-weight").value =
    titleFontWeight;
  document.getElementById("text-input-id-title-line-height").value =
    titleLineHeight;
  document.getElementById("text-input-id-title-font-color").value =
    titleFontColor;
  document.getElementById("text-input-id-subtitle").value = subtitle;
  document.getElementById("text-input-id-subtitle-font-size").value =
    subtitleFontSize;
  document.getElementById("text-input-id-subtitle-line-height").value =
    subtitleLineHeight;
  document.getElementById("text-input-id-subtitle-font-weight").value =
    subtitleFontWeight;
  document.getElementById("text-input-id-subtitle-font-color").value =
    subtitleFontColor;
  ...
  document.getElementById("text-input-id-data-extension-fallback").value =
    dataExtensionFallback;
  document.getElementById("text-input-id-price-label").value = priceLabel;
  document.getElementById("text-input-id-product-button-text").value =
    productButtonText;
  ...
  document.getElementById("select-input-id-product-count").value =
    sequenceNumber;
...
function paintHtml() {
  ...
  titleFontSize = document.getElementById(
    "text-input-id-title-font-size"
  ).value;
  titleLineHeight = document.getElementById(
    "text-input-id-title-line-height"
  ).value;
  titleFontWeight = document.getElementById(
    "text-input-id-title-font-weight"
  ).value;
  titleFontColor = document.getElementById(
    "text-input-id-title-font-color"
  ).value;
  subtitle = document.getElementById("text-input-id-subtitle").value;
  nullSubtitle = doNullTitleBooleans(subtitle);
  subtitleFontSize = document.getElementById(
    "text-input-id-subtitle-font-size"
  ).value;
  subtitleLineHeight = document.getElementById(
    "text-input-id-subtitle-line-height"
  ).value;
  subtitleFontWeight = document.getElementById(
    "text-input-id-subtitle-font-weight"
  ).value;
  subtitleFontColor = document.getElementById(
    "text-input-id-subtitle-font-color"
  ).value;
  ...
  dataExtensionFallback = document.getElementById(
    "text-input-id-data-extension-fallback"
  ).value;
  priceLabel = document.getElementById("text-input-id-price-label").value;
  productButtonText = document.getElementById(
    "text-input-id-product-button-text"
  ).value;
  ...
  sequenceNumber = document.getElementById(
    "select-input-id-product-count"
  ).value;
...
sdk.getData(function (data) {
  ...
  utmContentId = data.utmContentId || "reorder";
