...
import CONTENT_ONE_COLUMN from '../partials/js/content-one-column.js';

var SDK = require('blocksdk');
var sdk = new SDK(null, null, true); // 3rd argument true bypassing https requirement: not prod worthy

var buttonCenter, title, titleFontSize, titleFontWeight, titleLineHeight, titleFontColor, subtitle, subtitleFontSize, subtitleFontWeight, subtitleLineHeight, subtitleFontColor, description, descriptionFontSize, descriptionLineHeight, descriptionFontWeight, descriptionFontColor, buttonUrl, buttonText, imageUrl, imageDestinationUrl, imageAltText, nullTitle, nullSubtitle, nullDescription, noHeader, descriptionPaddingBottom, componentPaddingBottom, componentPaddingTop, subtitlePaddingBottom;
...
function paintHtml() {
	...
	sdk.setContent(CONTENT_ONE_COLUMN(data));
	sdk.setData(data);
}
