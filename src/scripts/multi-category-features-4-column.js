...
import MULTI_CATEGORY_FEATURES from '../partials/js/multi-category-features-4-column.js';

var SDK = require('blocksdk');
var sdk = new SDK(null, null, true); // 3rd argument true bypassing https requirement: not prod worthy

var categoryName, categoryName2, categoryName3, categoryName4, categoryNameFontWeight, categoryNameFontSize, categoryNameLineHeight, imageUrl, imageUrl2, imageUrl3, imageUrl4, imageAltText, imageAltText2, imageAltText3, imageAltText4, categoryUrl, categoryUrl2, categoryUrl3, categoryUrl4, padTop, padBottom, categoryNameColor;
...
function paintSettings () {
	...
	document.getElementById('text-input-id-font-color').value = categoryNameColor;
...
function paintHtml() {
	...
	categoryNameColor = document.getElementById('text-input-id-font-color').value;
