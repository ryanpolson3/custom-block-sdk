          ...
          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
             ...
             <tr>
                <td class="center-on-narrow"
                   ...
                   <h3 style="font-size: ${data.titleFontSize}px; font-weight: ${data.titleFontWeight}; line-height: 28px; font-family: Arial, sans-serif; color:#171717; margin: 0px 0 10px 0;">
                      ${data.title}
                   </h3>
                   <p style="font-size: ${data.subtitleFontSize}px; font-weight: ${data.subtitleFontWeight}; line-height: 24px; font-family: Arial, sans-serif; color:#565656;margin: 0 0 15px;">
                      ${data.subtitle}
                   </p>
       ...
       <td class="stack-column-center" valign="top" width="50%">
          <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
             ...
             <tr>
                <td class="center-on-narrow"                                                                               
                   style="font-family: Arial, sans-serif; font-size: 15px; line-height: 24px; color: #555555; text-align: ${data.centerAlign ? 'center' : 'left'}; padding: 0px 40px 40px;">
                   <h3 style="font-size: ${data.title2FontSize}px; font-weight: ${data.title2FontWeight}; line-height: 28px; font-family: Arial, sans-serif; color:#171717; margin: 0px 0 10px 0;">
                      ${data.title2}
                   </h3>
                   <p style="font-size: ${data.subtitle2FontSize}px; font-weight: ${data.subtitle2FontWeight}; line-height: 24px; font-family: Arial, sans-serif; color:#565656;margin: 0 0 15px;">
                      ${data.subtitle2}
                   </p>
                   <table border="0" cellpadding="0" cellspacing="0" class="center-on-narrow" role="presentation" style="${data.centerAlign ? '' : 'float: left;'}">
        <tbody>
