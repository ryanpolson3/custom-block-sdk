    ...
    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            ...
            <th class="stack-column-center" valign="top" width="33%">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tr>
                        <td class="center-on-narrow" style="font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: center;padding: 10px 0 0 0;">
                            <h3 style="font-size: 16px; line-height: 28px; font-family: Arial, sans-serif; color:#000000; font-weight:${data.iconFontWeight};">
             <a alias="${data.iconName}" conversion="true" data-linkto="${data.iconLink}" style="text-decoration:none;color:inherit" title="${data.iconName}">${data.iconName}</a></h3></td>
                    ...
                    <tr>
                        <td style="text-align: center;padding: 10px 10px 40px;">
            ...
            <th class="stack-column-center" valign="top" width="33%">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tr>
                        <td class="center-on-narrow" style="font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: center;padding: 10px 0 0 0;">
                            <h3 style="font-size: 16px; line-height: 28px; font-family: Arial, sans-serif; color:#000000; font-weight:${data.iconFontWeight2};">
            ...
            <th class="stack-column-center" valign="top" width="33%">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tr>
                        <td class="center-on-narrow" style="font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: center;padding: 10px 0 0 0;">
                            <h3 style="font-size: 16px; line-height: 28px; font-family: Arial, sans-serif; color:#000000; font-weight:${data.iconFontWeight3};">
