                                    ...
                                    <tbody>
                                        <tr>
                                            <td dir="ltr" style="padding: 0; overflow: hidden;" valign="top">
                                                ...
                                                <img width="100%" alt="alt_text" border="0" class="center-on-narrow"
                                                    alt="${
                                                      data.imageAltText
                                                    }" src="${data.imageUrl}"
                                                    style="background: ${
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="" dir="ltr"
                                                ...
                                                valign="top">
                                                <h3
                                                    style="font-size: 24px; line-height: 28px; font-family: Arial, sans-serif; color:${
                                                      data.titleColor
                                                    }; margin: 5px 0 10px 0;">
                                                    ${data.title}</h3>
                                                <p
                                                    style="font-size: 18px; line-height: 24px; font-family: Arial, sans-serif; color:${
                                                      data.subtitleColor
                                                    };font-weight: bold; margin: 0 0 15px;">
                                                    ${data.subtitle}</p>
                                                <p
                                                    style="font-size: 14px; line-height: 20px; font-family: Arial, sans-serif; color:${
                                                      data.titleColor
                                                    };margin: 0 0 25px;">
                                                    ${data.description}</p>
                                                ${
