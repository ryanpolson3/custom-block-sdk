         ...
         <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
            <tr>
               ...
               <th class="stack-column-center" valign="top" width="33%">
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                     <tr>
                        <td style="text-align: center; padding-top: 20px; padding-right: 0; padding-bottom: 0; padding-left: 0;">
                     ...
                     <tr>
                        <td class="center-on-narrow" style="font-family: Arial, sans-serif;; font-size: 15px; line-height: 24px; color: #555555; text-align: center; padding-top: 0px; padding-right: 0; padding-bottom: 20px; padding-left: 0;">
